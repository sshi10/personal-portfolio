...
export default function Page() {
  return (
    <section>
      ...
      <p className="mb-4">
        {`I’m Steven, a fourth-year Computer Engineering student at Stony Brook University. With a diverse set of interests spanning across software, engineering, product management, consulting, data science, and ML/AI, I am constantly driven by the pursuit of personal growth and enrichment.`}<br /><br />
